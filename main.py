...
if btn:
    ...
    with st.spinner(text="Building your " + craziness + " " + drink + " recipe ..."):
        ...
        with col2:
            ...
            #st.markdown(drink)
            prompt_4_diffusion = "Alcoholic " + drink + " drink named " + cocktail_name + ". Incoporate freeform, beautiful, harmony, unreal engine, v-ray, peace -iw 9 -q 2 -uplight --s 42000 --ar 4:3 --version 3"
